...
🔭 Final Year **BSc (Hons) in Information Technology** Undergraduate @ Horizon Campus  
💡 Passionate about bridging **Web Development** and **Artificial Intelligence** 🏆 **Best Presenter** - HIRS 2025 (Research on AI-driven Forecasting)  
🌱 Currently exploring **Next.js, Cloud Computing (AWS), and Advanced NLP** 💬 Ask me about **MERN Stack, Transfer Learning, or Computer Vision** </div>

<h2 align="center" style="color: #20C20E">✨ Tech Stack & Tools ✨</h2>
...
<div style="display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
  ...
  <img src="https://skillicons.dev/icons?i=tensorflow" alt="TensorFlow" title="TensorFlow" height="50"/>
  <img src="https://skillicons.dev/icons?i=pytorch" alt="Keras/PyTorch" title="Deep Learning" height="50"/>
  <img src="https://skillicons.dev/icons?i=sklearn" alt="Scikit-Learn" title="Scikit-Learn" height="50"/>
  <img src="https://skillicons.dev/icons?i=anaconda" alt="Anaconda" title="Anaconda" height="50"/>
</div>
...
<div style="display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
  ...
  <img src="https://skillicons.dev/icons?i=postman" alt="Postman" title="Postman" height="50"/>
  <img src="https://skillicons.dev/icons?i=vscode" alt="VSCode" title="VS Code" height="50"/>
</div>

</div>

<h2 align="center" style="color: #20C20E; margin-top: 30px;">🚀 Featured Projects</h2>

<div align="center">
  
| Project | Description | Tech Stack |
| :--- | :--- | :--- |
| **PetCareSL** | Full-stack pet adoption platform with an AI chatbot & vet directory. | React, Node.js, MongoDB, TensorFlow |
| **Skin Disease AI** | CNN model to classify 8 skin disease types (94% Accuracy). | Python, Keras, VGG16, NumPy |
| **Exercise Predictor** | Machine Learning model for exercise duration prediction (R²=0.977). | Scikit-learn, Pandas, Streamlit |
| **BackPackerLK** | Native Android app for travelers to discover Sri Lanka. | Java, Firebase, Android Studio |

</div>

<h2 align="center" style="color: #20C20E; margin-bottom: 20px; margin-top: 30px;">
